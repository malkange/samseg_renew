...
class SemKITTI_pt(data.Dataset):
    def __init__(self, data_path, cfgs, split='train', return_ref=False):
        ...
        # gh
        self.root_sam = data_path.replace('SemKITTI', 'SemKITTI_processed')  #'/home/poscoict/Desktop/SemKITTI_processed/dataset/sequences'
        ...
        # sequences
        if self.split == 'train':
            self.seqs =['00', '01', '02',  '04', '05', '06', '07', '09']  #'03',
        elif self.split == 'val':
            self.seqs =  ['08', '10']
        ...
        for seq in self.seqs:
            ...
            ids = np.linspace(0, len(path_list), int(len(path_list) * 0.1), dtype=int)
            mask_[ids] = True
